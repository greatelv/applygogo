...
export function UpgradeModal({
  ...
  const handlePurchase = async (productType: "PASS_1DAY" | "PASS_7DAY" | "PASS_30DAY") => {
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge variant="secondary" className="text-xs font-medium">
                    {Math.round((1 - (isGlobal ? PLAN_PRODUCTS.PASS_1DAY.priceGlobal / PLAN_PRODUCTS.PASS_1DAY.originalPriceGlobal : PLAN_PRODUCTS.PASS_1DAY.price / PLAN_PRODUCTS.PASS_1DAY.originalPrice)) * 100)}% {t("off")}
                  </Badge>
                </div>
              </div>
              ...
              <ul className="space-y-3 mb-8 flex-1 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-foreground">
                    {t("plans.pass1.features.0", {
                      credits: PLAN_PRODUCTS.PASS_1DAY.credits,
                    })}
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <CreditCard className="h-4 w-4 text-primary shrink-0" />
                  {t("plans.pass1.features.1")}
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="h-4 w-4 text-primary shrink-0" />
                  {t("plans.pass1.features.2")}
                </li>
                <li className="flex items-center gap-2">
                  <Calendar className="h-4 w-4 text-primary shrink-0" />
                  {t("plans.pass1.features.3", {
                    days: PLAN_PRODUCTS.PASS_1DAY.days,
                  })}
                </li>
              </ul>

              <Button
                onClick={() => handlePurchase("PASS_1DAY")}
                disabled={purchasingProduct === "PASS_1DAY"}
                className="w-full"
                variant="outline"
                size="lg"
              >
                {purchasingProduct === "PASS_1DAY" ? (
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge variant="secondary" className="text-xs font-medium bg-primary/10 text-primary border-primary/20">
                    {Math.round((1 - (isGlobal ? PLAN_PRODUCTS.PASS_7DAY.priceGlobal / PLAN_PRODUCTS.PASS_7DAY.originalPriceGlobal : PLAN_PRODUCTS.PASS_7DAY.price / PLAN_PRODUCTS.PASS_7DAY.originalPrice)) * 100)}% {t("off")}
                  </Badge>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge variant="destructive" className="text-xs font-medium">
                    {Math.round((1 - (isGlobal ? PLAN_PRODUCTS.PASS_30DAY.priceGlobal / PLAN_PRODUCTS.PASS_30DAY.originalPriceGlobal : PLAN_PRODUCTS.PASS_30DAY.price / PLAN_PRODUCTS.PASS_30DAY.originalPrice)) * 100)}% {t("off")}
                  </Badge>
                </div>
              </div>
