...
export function ResumeEditPage({
  ...
  return (
    <div className="max-w-6xl mx-auto pb-24">
      <div className="mb-8">
        <h1 className="text-2xl mb-2">{label("Editor", "편집")}</h1>
        <p className="text-sm text-muted-foreground">
          {label(
            "Review and edit the AI-analyzed content.",
        ...
        <div>
          ...
          <p className="text-xs text-blue-700 dark:text-blue-400 leading-relaxed">
            {label(
              ...
              "한글 내용을 수정하고 [동기화 후 재번역] 버튼을 누르면 AI가 변경된 내용에 맞춰 다시 번역해줍니다. 불필요한 항목은 휴지통 아이콘을 눌러 삭제하세요.",
            )}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="mb-6">
          <h2 className="text-xl font-semibold mb-2">
            {label("Personal Info", "기본 정보")}
          </h2>
          <p className="text-sm text-muted-foreground">
            {label(
              "Manage your essential personal details.",
        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            ...
            >
              {/* Korean Info - Hide in Global Mode */}
              {!isGlobalMode && (
            ...
            <div className="bg-card border border-border rounded-lg p-4 sm:p-6">
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex gap-2 max-w-xs relative top-0.5">
                  <Input
                    placeholder={label("New Skill", "새 기술 스택")}
                    value={newSkill}
